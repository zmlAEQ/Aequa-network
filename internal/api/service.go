...
func New(addr string, onPublish func(ctx context.Context, payload []byte) error, upstream string) *Service { return &Service{addr: addr, onPublish: onPublish, upstream: upstream} }
